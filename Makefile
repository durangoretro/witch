...
$(BUILD_DIR)/witch.bin: $(BUILD_DIR) $(BUILD_DIR)/main.o
	ld65 -m $(BUILD_DIR)/witch.txt -C $(CFG) $(BUILD_DIR)/main.o $(DCLIB)/glyph.lib $(DCLIB)/qgraph.lib $(DCLIB)/durango.lib $(DCLIB)/sprites.lib $(DCLIB)/system.lib $(DCLIB)/psv.lib -o $(BUILD_DIR)/witch.bin	
